...
export interface CertificateSheetProps {
  ...
  draftNotice?: string;
  /**
   * Whether to print the verification side.
   *
   * It carries a code and a QR that resolve against issued certificates. Where no code was
   * issued there is nothing truthful to print on it, and a code that fails verification is
   * worse than no back at all — so that side is left off rather than filled in.
   */
  showBack?: boolean;
}
        ...
        >
          <div className="absolute inset-0 flex flex-col items-center justify-center px-[12%] text-center">
            <p
              ...
              style={{ fontSize: "2.1cqw", letterSpacing: "0.28em" }}
            >
            ...
            <p
              className="mt-[1.5%]"
              style={{ fontSize: "2.2cqw", opacity: 0.75 }}
            >
              {verifyUrl}
            </p>
            ...
            <p
              className="mt-[3%]"
              style={{ fontSize: "2.2cqw", lineHeight: 1.6, opacity: 0.8 }}
            >
              Scan the code or open the address above to confirm this
              certificate against the tournament&rsquo;s records. Anyone can
              check it — no account is needed.
            </p>
          </div>
        </div>
      ) : null}
...
function Signature({
  ...
  return (
    ...
    >
      ...
      <p
        style={{ fontSize: "1.9cqw", opacity: 0.8 }}
