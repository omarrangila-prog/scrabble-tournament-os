          ...
          <div className="mt-5 flex flex-wrap gap-2.5">
            ...
            <a
              href={`https://wa.me/${CONTACT.whatsapp.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(
                "Hello, we reviewed the Pakistan Scrabble Association platform demonstration and would like to discuss the implementation scope.",
              )}`}
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href={`mailto:${CONTACT.email}?subject=${encodeURIComponent(
                "Pakistan Scrabble Association — implementation scope",
              )}&body=${encodeURIComponent(
                "Hello,\n\nWe reviewed the Pakistan Scrabble Association platform demonstration and would like to discuss next steps.\n\n",
              )}`}
            >
      ...
      <Modal
        ...
        footer={
          <div className="flex justify-end gap-2">
            ...
            <a
              href={`mailto:${CONTACT.email}?subject=${encodeURIComponent(
                "Pakistan Scrabble Association — customization request",
              )}`}
            >
