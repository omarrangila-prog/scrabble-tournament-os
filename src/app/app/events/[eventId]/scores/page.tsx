...
/**
 * Scores & Standings for the active event.
 *
  ...
  return (
    <Card>
      <EmptyState
        ...
        description="Score entry, verification and live standings."
        action={
          <Button variant="primary" onClick={() => router.push("/app/standings")}>
            Open Scores & Standings
