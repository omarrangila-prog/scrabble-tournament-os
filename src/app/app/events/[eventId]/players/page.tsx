...
/**
 * Players & Divisions for the active event.
 *
...
export default function PlayersPage() {
  ...
  return (
    <Card>
      <EmptyState
        title="Players & Divisions"
        description="Divisions, seeding and player history."
        action={
          <Button variant="primary" onClick={() => router.push("/app/seeding")}>
            Open Players & Divisions
